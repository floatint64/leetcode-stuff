...
class CheckIfEveryRowAndColumnContainsAllNumbersTest {
    ...
    void checkValid() {
        ...
        CheckIfEveryRowAndColumnContainsAllNumbers checkIfEveryRowAndColumnContainsAllNumbers = new CheckIfEveryRowAndColumnContainsAllNumbers();
        ...
        Assertions.assertTrue(checkIfEveryRowAndColumnContainsAllNumbers.checkValid(matrix));
    }
    ...
    void checkValid2() {
        ...
        Assertions.assertFalse(checkIfEveryRowAndColumnContainsAllNumbers.checkValid(matrix));
    }
